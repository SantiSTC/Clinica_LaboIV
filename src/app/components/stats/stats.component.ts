...
@Component({
  selector: 'app-stats',
  standalone: true,
  imports: [RouterLink, FormsModule, PrimeraLetraAMayusPipe, TurnosPorEspecialidadComponent, TurnosPorDiaComponent, TurnosSolicitadosMedicoComponent, TurnosFinalizadosMedicoComponent, GetNombreDelEspecialistaPipe, ToolTipDirective],
...
export class StatsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.getTurnosPorMedico();
    // this.getTurnosFinalizadosPorMedico();
